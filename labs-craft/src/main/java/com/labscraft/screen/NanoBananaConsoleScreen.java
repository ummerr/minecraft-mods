...
public class NanoBananaConsoleScreen extends HandledScreen<NanoBananaConsoleScreenHandler> {
    ...
    private static final int THEME_COLOR = 0xFFFFD700;
    private static final int THEME_DARK = 0xFF2a2a1e;
    private static final int THEME_HEADER = 0xFF3a3a2e;
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        if (handler.isGenerating()) {
            ...
            if (fillWidth > 0) {
                ...
                // Shimmer highlight
                float shimmer = (float) Math.sin((animationTick + delta) * 0.2) * 0.5f + 0.5f;
    ...
    protected void drawForeground(DrawContext context, int mouseX, int mouseY) {
        ...
        String countText = "Total images: " + count;
        int countX = (this.backgroundWidth - this.textRenderer.getWidth(countText)) / 2;
        int countColor = count > 0 ? 0xFFD700 : 0x888888;
