...
public class VeoConsoleScreen extends HandledScreen<VeoConsoleScreenHandler> {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawBorder(x, y, this.backgroundWidth, this.backgroundHeight, 0xFF9966FF);

        // Draw title area
        context.fill(x + 1, y + 1, x + this.backgroundWidth - 1, y + 20, 0xFF2a2a4e);
        ...
        context.drawBorder(barX, barY, barWidth, barHeight, 0xFF9966FF);
        ...
        if (handler.isGenerating()) {
            ...
            if (fillWidth > 0) {
                context.fill(barX + 1, barY + 1, barX + 1 + fillWidth, barY + barHeight - 1, 0xFF9966FF);
            }
        }
    }
    ...
    protected void drawForeground(DrawContext context, int mouseX, int mouseY) {
        ...
        String countText = "Total videos: " + handler.getTotalGenerations();
