...
public class NanoBananaConsoleBlock extends AbstractConsoleBlock {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.NANO_BANANA_CONSOLE, AbstractConsoleBlockEntity::tick);
    }
}
